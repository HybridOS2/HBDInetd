...
extern const char *ifc_ipaddr_to_string(in_addr_t addr);
extern int ifc_string_to_ip(const char *string, struct sockaddr_storage *ss);
...
extern in_addr_t ifc_ipv4_prefix_length_to_netmask(int prefix_length);
extern int ifc_ipv4_netmask_to_prefix_length(in_addr_t mask);
