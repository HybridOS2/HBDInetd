...
const char *kvlist_set_ex(struct kvlist *kv,
        const char *name, const void *data) WTF_INTERNAL;
...
bool kvlist_remove(struct kvlist *kv, const char *name) WTF_INTERNAL;
int kvlist_strlen(struct kvlist *kv, const void *data) WTF_INTERNAL;
