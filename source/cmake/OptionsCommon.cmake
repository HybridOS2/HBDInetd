...
HBDINETD_CHECK_HAVE_INCLUDE(HAVE_FEATURES_H features.h)

# Check for headers
HBDINETD_CHECK_HAVE_INCLUDE(HAVE_ERRNO_H errno.h)
HBDINETD_CHECK_HAVE_INCLUDE(HAVE_LANGINFO_H langinfo.h)
HBDINETD_CHECK_HAVE_INCLUDE(HAVE_MMAP sys/mman.h)
HBDINETD_CHECK_HAVE_INCLUDE(HAVE_PTHREAD_NP_H pthread_np.h)
HBDINETD_CHECK_HAVE_INCLUDE(HAVE_SYS_PARAM_H sys/param.h)
HBDINETD_CHECK_HAVE_INCLUDE(HAVE_SYS_TIME_H sys/time.h)
HBDINETD_CHECK_HAVE_INCLUDE(HAVE_SYS_TIMEB_H sys/timeb.h)
HBDINETD_CHECK_HAVE_INCLUDE(HAVE_LINUX_MEMFD_H linux/memfd.h)
HBDINETD_CHECK_HAVE_INCLUDE(HAVE_SYSLOG_H syslog.h)

# Check for functions
HBDINETD_CHECK_HAVE_FUNCTION(HAVE_ALIGNED_MALLOC _aligned_malloc)
HBDINETD_CHECK_HAVE_FUNCTION(HAVE_ISDEBUGGERPRESENT IsDebuggerPresent)
HBDINETD_CHECK_HAVE_FUNCTION(HAVE_LOCALTIME_R localtime_r)
HBDINETD_CHECK_HAVE_FUNCTION(HAVE_MALLOC_TRIM malloc_trim)
HBDINETD_CHECK_HAVE_FUNCTION(HAVE_STRNSTR strnstr)
HBDINETD_CHECK_HAVE_FUNCTION(HAVE_TIMEGM timegm)
HBDINETD_CHECK_HAVE_FUNCTION(HAVE_VASPRINTF vasprintf)
HBDINETD_CHECK_HAVE_FUNCTION(HAVE_VSYSLOG vsyslog)
HBDINETD_CHECK_HAVE_FUNCTION(HAVE_ALLOCA alloca)

# Check for symbols
HBDINETD_CHECK_HAVE_SYMBOL(HAVE_REGEX_H regexec regex.h)
if (NOT (${CMAKE_SYSTEM_NAME} STREQUAL "Darwin"))
HBDINETD_CHECK_HAVE_SYMBOL(HAVE_PTHREAD_MAIN_NP pthread_main_np pthread_np.h)
endif ()
# Windows has signal.h but is missing symbols that are used in calls to signal.
HBDINETD_CHECK_HAVE_SYMBOL(HAVE_SIGNAL_H SIGTRAP signal.h)

# Check for struct members
HBDINETD_CHECK_HAVE_STRUCT(HAVE_STAT_BIRTHTIME "struct stat" st_birthtime sys/stat.h)
HBDINETD_CHECK_HAVE_STRUCT(HAVE_TM_GMTOFF "struct tm" tm_gmtoff time.h)
HBDINETD_CHECK_HAVE_STRUCT(HAVE_TM_ZONE "struct tm" tm_zone time.h)
